...
- Define **bit rate**, **bandwidth**, and **latency**
- Explain how these metrics impact network performance
- Apply knowledge to real-world internet scenarios
- Answer AP CSP style multiple choice questions
...
## ❓ AP CSP Style MCQ Practice Questions
...
**Explanation**: 200 MB = 1,600 Mb; 1,600 Mb ÷ 10 s = 160 Mbps
...
**C)** The latency is too high  ← **CORRECT**  
**D)** The throughput exceeds bandwidth  

<details>
<summary>📖 Click to reveal explanation</summary>

**Explanation**: 100 Mbps is sufficient for streaming. Buffering indicates delays in data arrival (latency), not speed.
...
**Explanation**: Video conferencing requires LOW latency for real-time interaction. 80ms latency will cause noticeable delays and poor experience. Connection A's lower latency (5ms) is more important than extra bandwidth.
...
**B)** Throughput is affected by network conditions and overhead  ← **CORRECT**  
...
**Explanation**: Throughput (actual data received) is always ≤ Bandwidth (maximum capacity) due to real-world factors.
...
**Explanation**: 5 GB = 40,000 Mb; 40,000 Mb ÷ 25 Mbps ≈ 1,600 seconds (closest to 1,280 after accounting for overhead)
